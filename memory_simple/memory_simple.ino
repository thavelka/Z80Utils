...
/* 
 * Memory and output checkout with fibonacci. Repeatedly outputs value one, value two, then the sum.
 * Requires only output at port 0.
 */
//byte ROM[64] = {
...
//  0xC3, 0x0E, 0x00  // JP 14: Jump to line 14
//};
